...
export default function Login ({navigation}){
    return(
        <View style={{backgroundColor:colors.primBG, flex:1, }}>
            
            <StatusBar barStyle = "light-content" backgroundColor={colors.primColor} />
            ...
            <View style={styles.Login}>
                ...
                <View style={{marginTop:30}}>
                        ...
                        <TouchableOpacity style={styles.loginbtn}  activeOpacity={0.8} onPress={() => navigation.navigate('BottomTabs')}>
                    ...
                    <View style={{alignSelf:'center', paddingBottom:15, flexDirection:'row'}}>
                        ...
                        <TouchableOpacity activeOpacity={0.4}>
                        <Image source={require('../Image/google-plus.png')}
                        style={{height:50, width:50, margin:8,}}
