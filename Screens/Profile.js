...
return (
    ...
    <View style={styles.userInfoSection}>
      ...
      <View style={styles.menuWrapper}>
        ...
        <TouchableOpacity onPress={() => {}}>
          <View style={styles.menuItem}>
            <Icon name="folder-outline" color={colors.primColor} size={25}/>
            <Text style={styles.menuItemText}>Documents</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {}}>
          <View style={styles.menuItem}>
            <Icon name="share-outline" color={colors.primColor}size={25}/>
            <Text style={styles.menuItemText}>Tell Your Friends</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {}}>
        <View style={styles.menuItem}>
            <Icon name="account-check-outline"color={colors.primColor} size={25}/>
            <Text style={styles.menuItemText}>Support</Text>
        </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => {}}>
        <View style={styles.menuItem}>
            <Icon name="cog-outline" color={colors.primColor} size={25}/>
